<template>
    <span data-toggle="tooltip" :data-placement="position"
          :title="title"
          :class="['info-tooltip', {'absolute-tooltip':absolute}]">
<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
width="32px" height="32px" viewBox="0 0 45.999 45.999" xml:space="preserve">
