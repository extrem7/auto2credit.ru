<template>
    <div class="timer">
        <div class="container text-center">
            <div class="second-title big-size">Уважаемый(ая) {{$store.getters.firstName}}, Ваша заявка <br>
                успешно отправлена!
            </div>
            <div class="success-box mx-auto">
                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                         viewBox="0 0 442.533 442.533" xml:space="preserve">
            ...
            <div class="text-center mb-0 mb-md-5">Наши специалисты свяжутся <br> с Вами в течение 15 минут :)
            </div>
        </div>
    </div>
</template>